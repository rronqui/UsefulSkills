...
for (const line of input.split("\n")) {
  // Checa o local ref (campo 1) E o remote ref (campo 3): refspecs como
  // 'git push origin HEAD:main' enviam HEAD/feature no campo 1 e
  // refs/heads/main no campo 3 — checar só o local deixa o push passar.
  const [localRef, , remoteRef] = line.split(" ");
